...
心理統計教育の授業シラバス（コマシラバス）と授業の教材です。うんこうんこ
...
この文書はTeXで書かれており，uplatexを使ってコンパイルします。
シラバスを見るためには，syllabusフォルダの中にあるcompile.shを実行し，TeXをコンパイルします。PDFファイルが一つ上の階層に出来上がります。MacTeX2019環境で実行を確認しています。
教材はcourse_materialsフォルダの中にあります。
