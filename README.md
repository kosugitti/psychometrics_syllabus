...
教材を全て印刷するのは大変，という人のために Amazon にてペーパーバック版を用意しています。
ペーパーバック版は基礎編バージョン 2.0.1，応用編バージョン 1.2.1 のものになります。
...
「深層学習は心理学に革新をもたらすか？　オープンサイエンスによる理論的・実践的検証」というプロジェクトの一環で，2022 年夏の数学ワークショップの講師を担当させていただくことになりました。その時の資料をこちらにおいております。誤字脱字や，正しくない表現などWSの最中に指摘を受けて口頭で訂正したものがまだ直っておりませんので，ここに書いてあることは「うん？ほんとうかな？」と思いながら読んでください。
...
- [心理尺度と測定・分析モデル(仮)](Hiroshima_book.pdf)
