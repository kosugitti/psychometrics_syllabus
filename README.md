...
+ **[統計環境Rによる実践]** 統計環境Rを利用して，理論的な理解だけでなく実際に計算ができることも身につけるべき技術である。
...
+ [心理学データ解析基礎1(心理学統計法)/心理学データ解析1AB/心理学データ解析2](syllabus.pdf)
+ [心理学データ解析応用1](syllabus2.pdf)

### 授業資料

+ [心理学データ解析基礎1(心理学統計法)/心理学データ解析1A授業資料](Dkiso1_book.pdf)
