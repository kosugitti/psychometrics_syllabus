...
\begin{figure}[ht]
    \centering
    \includegraphics[keepaspectratio,width=12cm]{../images/27_bayesian3/Rplot27_01.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[keepaspectratio,width=12cm]{../images/27_bayesian3/slide27_02.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[keepaspectratio,width=12cm]{../images/27_bayesian3/slide27_01.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[keepaspectratio,width=12cm]{../images/27_bayesian3/slide27_03.png}
    \caption{周辺平均値の推定結果}
    \label{fig::27_04}
\end{figure}
\section{群内モデルの推定}
