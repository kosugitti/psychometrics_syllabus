...
"So, what should we do? This refers to a test after this analysis of variance, which is called a subordinate test or a post-hoc analysis, and various methods have been proposed for this post-hoc analysis. It is difficult to say definitively which is good or bad (to the point where there is a standalone professional book on this \citep{BA33892274}). However, it would be troubling if not, so I will introduce two methods."
