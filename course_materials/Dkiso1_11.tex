...
それよりも大事なのは下から二行目にある，\texttt{Multiple R-squared}というところです。これがいわゆる$R^2$値であり，モデルの\keytermL{適合度}{てきごうど}を表しています。今回は$R^2=0.3844$ですから，予測値$\hat{y}$と従属変数$y$の相関係数が0.62ぐらい，分散説明率が38.4\% ぐらいだったということがわかります。悪い当てはまとしては，やや悪いといったところでしょうか。
