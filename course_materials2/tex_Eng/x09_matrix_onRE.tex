...
\input{x09_matrix_onR_escape_01}

% \paragraph{コード解説}
\paragraph{Code Explanation}
\input{x09_matrix_onR_escape_02}
...
\input{x09_matrix_onR_escape_03}
...
\input{x09_matrix_onR_escape_04}
% \paragraph{コード解説}
\paragraph{Code Explanation}
\input{x09_matrix_onR_escape_05}

\input{x09_matrix_onR_escape_06}
...
\input{x09_matrix_onR_escape_07}
% \paragraph{コード解説}
\paragraph{Code Explanation}
\input{x09_matrix_onR_escape_08}
...
\input{x09_matrix_onR_escape_09}
% \paragraph{コード解説}
\paragraph{Code Explanation}
\input{x09_matrix_onR_escape_10}
...
\input{x09_matrix_onR_escape_11}
% \paragraph{コード解説}
\paragraph{Code Explanation}
\input{x09_matrix_onR_escape_12}
...
\input{x09_matrix_onR_escape_13}
\input{x09_matrix_onR_escape_14}
...
\input{x09_matrix_onR_escape_15}

% 表\ref{tbl::09_01}に示したのは，データ解析基礎でも扱った2000年代の野球選手のデータです\footnote{伴走サイト\url{https://kosugitti.github.io/psychometrics_syllabus/}より，サンプルデータにある「野球選手のデータ 10 年度分」を選んでください。ファイルはUTF-8形式で保存されています。}。それをプロジェクトフォルダに置き，\texttt{code:\ref{code:09_05}}のコードを実行してください。
Table \ref{tbl::09_01} shows the data of baseball players from the 2000s, which was also covered in the Basics of Data Analysis \footnote{From the companion site \url{https://kosugitti.github.io/psychometrics_syllabus/}, please select "10 years data of baseball players" in the sample data. The file is saved in UTF-8 format.}. Please place it in the project folder and execute the code \texttt{code:\ref{code:09_05}}.

\input{x09_matrix_onR_escape_16}
\input{x09_matrix_onR_escape_17}
\end{description}
...
\input{x09_matrix_onR_escape_18}
\input{x09_matrix_onR_escape_19}
\input{x09_matrix_onR_escape_20}
\input{x09_matrix_onR_escape_21}
\input{x09_matrix_onR_escape_22}

\input{x09_matrix_onR_escape_23}
\input{x09_matrix_onR_escape_24}
...
\input{x09_matrix_onR_escape_25}
...
\input{x09_matrix_onR_escape_26}
...
% \section{課題}
\section{Tasks}
\input{x09_matrix_onR_escape_27}
