...
次に確率的プログラミング言語，Stanの導入を行います。StanをRから使えるようにするものとして，\texttt{rstan}パッケージがあります。
...
出力例はちょっと違ってきますが，\texttt{mu}の\texttt{mean}が7.8ぐらいの数字になっていればOKです。それがどういう意味なのかは，授業内でおいおい説明します。
