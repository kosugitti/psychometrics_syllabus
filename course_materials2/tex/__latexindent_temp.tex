...
表\ref{tbl::09_01}に示したのは，いつもの野球選手のデータです。それをプロジェクトフォルダに置き，\texttt{code:\ref{code::09_05}}のコードを実行してください。
