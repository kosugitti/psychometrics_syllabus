...
irtSample <- summary(result.irt)$coefficients %>% as.data.frame %>% 
    rownames_to_column("var") %>% 
    mutate(type= str_split(var,pattern = "\\.",simplify = T)[,1],
