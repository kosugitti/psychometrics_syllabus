...
\begin{equation}
    \bm{R}=\bm{a}_1\bm{a}_1'+\bm{a}_2\bm{a}_2'+\cdots +\bm{a}_p\bm{a}_p'+\bm{d} \bm{d}' =\bm{AA}'+\bm{D}
\end{equation}
...
ところで因子分析モデルの$\bm{A}$，因子負荷行列ですが，これは共通因子の固有ベクトルをセットで扱ったものです。つまり，$\bm{A} = \bm{a_1,a_2,\cdots,a_p}$と縦ベクトルを並べたものになっています。エレメントワイズで表現すると次のようになります。
