...
## Lesson 5. Alternatives for t-test2. Rstan Version
...
model <- rstan::stan_model("rstan/ttest05.stan")
...
model <- rstan::stan_model("rstan/ttest06.stan")
groupA <- c(30, 50, 70, 90, 60, 50, 70, 60)
groupB <- c(20, 40, 60, 40, 40, 50, 40, 30)
